<template>
    <div class="card privacy">
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to QuizApp, accessible from <a href="www.quizapp.at"
                        rel="external nofollow noopener" target="_blank">www.quizapp.at</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: support@quizapp.at</p>
            </li>
            <li>
                <p>By visiting this page on our website: <router-link to="/contact">Here</router-link>
                    you can
                    find our contact form.</p>
            </li>
        </ul>
    </div>
</template>